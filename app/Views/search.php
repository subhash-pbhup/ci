...
<script>
    $(document).ready(function() {
        ...
        $("#fetch_data").click(function() {
            ...
            fetch("https://pixabay.com/api/" + data_type + "?key=45076340-0dbf655cf5663999da44a9549&q=" + q + "&image_type=all&pretty=true&video_type=all&per_page=50")
  ...
  <img src='${hits.largeImageURL}'>
                    ...
                    alert('The server is not working this time, please try after some time..!');
                });
